package com.tairui.smartcommunity.tenant.service;
...
import com.tairui.smartcommunity.tenant.model.FileResponseBody;
import com.tairui.smartcommunity.tenant.net.FileCallback;
...
public class DownLoadService extends Service {
     ...
     * 目标文件存储的文件名
     */
    private String destFileName = "Tairui.apk";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        destFileName = fileUrl.substring(fileUrl.lastIndexOf("/") + 1);
    ...
    public void initNotification() {
        builder = new NotificationCompat.Builder(mContext)
                ...
                .setContentTitle(getResources().getString(R.string.app_name))// 标题
